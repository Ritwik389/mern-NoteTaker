...
const CreateNote = () => {
  ...
  const [content, setContent] = useState("");  //these both states aare to keep track of what user is inputting
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if(error.response.status === 429){
        toast.error("Slow down! you are creating too many notes at a time", {
          duration: 4000,
          icon: "☠️",
        });
      }
